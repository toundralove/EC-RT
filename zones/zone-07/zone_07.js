function initZone02() {
  ...
  const buildPath = "./07_MC/Build"
  const loaderUrl = buildPath + "/07_MC.loader.js";

  const config = {
    dataUrl: buildPath + "/07_MC.data.unityweb",
    frameworkUrl: buildPath + "/07_MC.framework.js.unityweb",
    codeUrl: buildPath + "/07_MC.wasm.unityweb",
