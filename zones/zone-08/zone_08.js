function initZone02() {
  ...
  const buildPath = "../../unity/zone08/Build";
  const loaderUrl = buildPath + "/08_FS.loader.js";

  const config = {
    dataUrl: buildPath + "/08_FS.data.unityweb",
    frameworkUrl: buildPath + "/08_FS.framework.js.unityweb",
    codeUrl: buildPath + "/08_FS.wasm.unityweb",
