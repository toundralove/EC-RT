function initZone02() {
  ...
  const buildPath = "./04_NWMV/Build"
  const loaderUrl = buildPath + "/04_NWMV.loader.js";

  const config = {
    dataUrl: buildPath + "/04_NWMV.data.unityweb",
    frameworkUrl: buildPath + "/04_NWMV.framework.js.unityweb",
    codeUrl: buildPath + "/04_NWMV.wasm.unityweb",
