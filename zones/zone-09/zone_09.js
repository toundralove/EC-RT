function initZone02() {
  ...
  const buildPath = "./09_ID/Build"
  const loaderUrl = buildPath + "/09_ID.loader.js";

  const config = {
    dataUrl: buildPath + "/09_ID.data.unityweb",
    frameworkUrl: buildPath + "/09_ID.framework.js.unityweb",
    codeUrl: buildPath + "/09_ID.wasm.unityweb",
