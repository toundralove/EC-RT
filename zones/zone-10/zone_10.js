function initZone02() {
  ...
  const buildPath = "10_COUM/Build";
  const loaderUrl = buildPath + "/10_COUM.loader.js";

  const config = {
    dataUrl: buildPath + "/10_COUM.data.unityweb",
    frameworkUrl: buildPath + "/10_COUM.framework.js.unityweb",
    codeUrl: buildPath + "/10_COUM.wasm.unityweb",
